...
export default function SearchProductSuggest({ query = '', searchProductsResult, searchValue }: SearchProductsProps) {
  ...
  return (
    <div className='bg-white shadow-md overflow-hidden rounded-sm z-20 flex flex-col'>
      <Link to='#' className='flex items-center text-black/85 truncate text-sm leading-4 no-underline p-[0.625rem]'>
        <svg
          ...
          .map((product) => {
            ...
            return (
              <Link
                ...
                className='flex items-center text-black/85 truncate text-sm leading-4 no-underline p-[0.625rem]'
              >
